...
export default function AdminCalendarPage() {
  ...
  return (
    <DashboardShell
      title="Calendar"
      subtitle="Final interviews and recruiter interviews synced with Google Calendar"
    >
      <div className="grid gap-4 xl:grid-cols-5">
        ...
        <Card className="xl:col-span-2">
          <h3 className="mb-3 font-semibold">Upcoming HireFlow events</h3>
          <Table headers={["Candidate", "Stage", "When", "Meet"]}>
            {events.map((e) => (
              <tr key={e._id}>
                ...
                <Td>
                  {e.googleMeetLink ? (
                    <a className="text-[var(--primary)] underline" href={e.googleMeetLink} target="_blank">
                      Join
                    </a>
                  ) : (
                    "—"
